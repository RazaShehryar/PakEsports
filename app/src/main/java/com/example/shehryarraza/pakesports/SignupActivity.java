...
public class SignupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ArrayAdapter<String> spinner_countries = new  ArrayAdapter<String>(SignupActivity.this,android.R.layout.simple_spinner_dropdown_item, countries_list);
